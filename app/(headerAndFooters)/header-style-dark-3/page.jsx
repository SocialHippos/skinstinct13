...
import Header1Dark from "@/components/Header";
import React from "react";
import Link from "next/link";
import Image from "next/image";
export const metadata = {
  title:
    "Header Dark Style 3 | Skinstinct",
          ...
          >
            <div className="container">
              <div className="dlab-bnr-inr-entry">
                <h1 className="text-skinstinct-brown">Header Style Topbar Primary</h1>
                {/* Breadcrumb row */}
...
export const metadata = {title:'Home | Skinstinct',description:'Skinstinct'}
