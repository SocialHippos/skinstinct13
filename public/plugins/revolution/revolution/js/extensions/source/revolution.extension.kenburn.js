...
jQuery.extend(true,_R, {
	...
	startKenBurn :  function(l,opt,prgs) {		
		...
		if (l.find('.tp-kbimg').length==0) {
			...
			l.append('<div className="tp-kbimg-wrap '+mediafilter+'" style="z-index:2;width:100%;height:100%;top:0px;left:0px;position:absolute;"><img className="tp-kbimg" src="'+s+'" style="position:absolute;" width="'+d.owidth+'" height="'+d.oheight+'"></div>');
